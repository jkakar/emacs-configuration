...
** Fonts and faces
   I use on ~set-face-attribute~ for global faces instead of ~custom-set-faces~
...
** Environment
   We need to be able to find Homebrew-installed executables.
   ...
   #+BEGIN_SRC emacs-lisp :tangle yes
     (use-package dumb-jump
       ...
       :config (setq dumb-jump-force-searcher 'rg)
               ...
               (setq dumb-jump-rg-cmd "/usr/local/bin/rg") ;; TODO /usr/local/bin is in exec-path... why is this needed?
