(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (base16-theme json-mode sql-mode git-link edts erlang thrift projectile counsel-projectile crux graphviz-dot-mode go-eldoc go-mode flycheck dumb-jump magit smex counsel swiper ws-butler exec-path-from-shell use-package)))
